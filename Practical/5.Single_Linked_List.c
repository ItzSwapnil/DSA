/*
5) WAP to create a Single Linked List and perform the following operations: (Options: 1:
create a list containing 08 values/nodes, 2: display the list, 3: add/insert a node at
